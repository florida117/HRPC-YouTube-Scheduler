...
with open(home_dir + '/git/HRPC-YouTube-Scheduler/Service_Details/morning_service_id.txt', 'r') as file:
...
no_evening = Path(home_dir + "/git/HRPC-YouTube-Scheduler/Service_Details/eve_no.txt")
