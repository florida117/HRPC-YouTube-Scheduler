...
# Read the Christmas service video ID from file
with open(HOME + '/git/HRPC-YouTube-Scheduler/Service_Details/christmas_service_id.txt', 'r') as file:
    VIDEO_URL_1 = 'https://www.youtube.com/watch?v=' + file.read().strip()

# Second video slot is intentionally left blank for Christmas
VIDEO_URL_2 = ''
...
# Replace both: first gets the Christmas video, second is set to blank
