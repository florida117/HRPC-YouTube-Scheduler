...
def authenticate(home_dir):
    ...
    credentials_file = '/Users/odysseus/yt-dlp/HRPC_Python/token.pickle'
...
if __name__ == '__main__':
    ...
    f = open(home_dir + "/yt-dlp/evening_service_id.txt", "r")
    temp1 = f.readline()
    VIDEO_ID = temp1.strip()
    f.close()

    LANGUAGE = 'en-GB'  # English (United Kingdom)
    f = open(home_dir + "/yt-dlp/evening_service_title.txt", "r")
    temp2 = f.readline()
    NAME = temp2.strip()
    f.close()
