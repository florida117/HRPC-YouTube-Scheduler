...
def write_title(home_dir):
    ...
    f.write("HRPC Sunday Morning Service" + " " + str(next_sunday_day) + " " + str(next_sunday_month) + " " + str(next_sunday_year))
    f.close()
...
def main():
    ...
    msg = f"Morning broadcast has been successfully created and categorized as Nonprofits & Activism."
    print(msg)
