...
MORNING_VIDEO_URL=$(<$HOME/yt-dlp/morning_service_id.txt)
EVENING_VIDEO_URL=$(<$HOME/yt-dlp/evening_service_id.txt)
# And the same for the name
MORNING_VIDEO_NAME=$(<$HOME/yt-dlp/morning_service_title.txt)
EVENING_VIDEO_NAME=$(<$HOME/yt-dlp/evening_service_title.txt)
