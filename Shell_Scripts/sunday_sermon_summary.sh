...
USER_PROMPT=$'Return 2–3 sentences (≈350 characters max), plain English, warm but not “church-insider,” and include zero emojis or hashtags. Emphasise the big idea + everyday relevance. Avoid repeating the title or reading out the Bible reference. Use only the transcript below.'
# ==========================
